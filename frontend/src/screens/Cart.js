...
const Cart = ({ match, location, history }) => {
  ...
  return (
    <div className='flex flex-col lg:flex-row mb-4 items-start justify-between'>
      ...
      <div className='w-4/12 mt-8'>
        ...
        <div className='flex flex-col mt-4 uppercase'>
          <div className='flex flex-row w-1/2 text-xl border-b-2 border-gray-400 py-4'>
            <p>Quantity:</p>
          ...
          <div className='flex flex-row w-1/2 text-xl py-4 justify-center mt-4'>
            <button
              onClick={() => checkoutHandler()}
              className={
                `${items.length === 0 ? 'cursor-not-allowed' : ''}` +
                ' text-base uppercase border w-full h-12 px-4 text-white bg-gray-800 hover:opacity-75'
              }
