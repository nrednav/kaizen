          ...
          <>
            <div className='flex flex-col mt-4 w-full'>
              <div className='flex flex-row border-b-2 border-gray-400 py-4 font-semibold text-center'>
                <div className='w-2/12 md:w-1/12'>Image</div>
                <div className='md:hidden w-4/12'>Details</div>
                <div className='hidden md:block w-3/12'>Name</div>
                <div className='hidden md:block w-3/12'>Price</div>
              ...
              {items.map((item) => (
                <div className='flex flex-row mt-4' key={item.product}>
                  ...
                  <div className='md:hidden w-4/12 flex flex-col items-center justify-center'>
                    <p>{item.name}</p>
                    <p>${item.price}</p>
                  </div>
                  <div className='hidden w-3/12 md:flex items-center justify-center'>
                    <p>{item.name}</p>
                  </div>
                  <div className='hidden w-3/12 md:flex items-center justify-center'>
                    <p>${item.price}</p>
